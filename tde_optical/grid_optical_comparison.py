...
def model_comparison(direcs: List[str], colour, disk_specs: List[str] = None, extrafname: str = "", wmin: float = 4000,
    ...
    iidx = 0
    ylims = [(1e-4, 1e-2), (1e-4, 1e-2), (1e-4, 1e-2)]
    alpha = 1.0
...
def main(argc: int, argv: List[str]) -> None:
    ...
    print("1")
    fig, ax = model_comparison(plot1.copy(), "C2", disk, "_optical_aaa", wmin, wmax, label="Mbh=N/A,Rmin=10,Vinf=0.1", return_figure=True)
    print("2")
    fig, ax = model_comparison(plot2.copy(), "C1", disk, "_optical_aaa", wmin, wmax, return_figure=True, figure=(fig, ax), label="Mbh=1e7,Rmin=15,Vinf=0.5")
    print("3")
    model_comparison(plot3.copy(), "C0", disk, "_optical_aaa", wmin, wmax, return_figure=False, figure=(fig, ax), label="Mbh=1e8,Rmin=5,Vinf=0.8")
