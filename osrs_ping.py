...
"""
The purpose of this script is to be able to easily query the ping to the
OldSchool RuneScape worlds which have been specified at run time. It looks like
the OldSchool servers don't like it when you ping a world repeatedly though..
when you do this, the ping increases between each ping >:(
"""
